...
export async function GET(){
  try{
    ...
    const [hospitals,administrations,departments,jobTitles,staffing]=await db.batch([
      ...
      db.prepare("SELECT id,name,active FROM job_titles ORDER BY name"),
    ...
    return NextResponse.json({hospitals:hospitals.results,administrations:administrations.results,departments:departments.results,jobTitles:jobTitles.results,staffing:staffing.results});
